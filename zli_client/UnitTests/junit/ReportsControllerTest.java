...
public class ReportsControllerTest {
	...
	// checking functionality: check if true when the report type is income histogram
		...
		@Test
		public void isReportHistogram_sameType() {
		...
		@Test
		public void isReportHistogram_diffrenetType() {
		...
		@Test
		public void isReportHistogram_reportNull() {
			try {
		...
		// expected result: false
		@Test
		public void isReportHistogram_reportEmpty() {
		...
		@Test
		public void setDateRangeQuarterForQuery_existingQuarterReport() {
			try {
		...
		@Test
		public void setDateRangeQuarterForQuery_noteExistingQuarter() {
			try {
				String expected = "";
		...
		// expected result: empty string
		@Test
		public void setDateRangeQuarterForQuery_emptyReportWithNoDate() {
			try {
				String expected = "";
		...
		// expected result: NullPointerException
		@Test
		public void setDateRangeQuarterForQuery_nullReport() {
			try {
