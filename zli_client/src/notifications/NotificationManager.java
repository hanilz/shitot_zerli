...
/**this class is used to manage all the notifications generated by the sever and the client
 * @author Eitan
 *
 */
public class NotificationManager {
	...
	/**used to mark a notification status as read in the DB
	 * @param notifiction
	 */
	...
	/**used to delete a notification form the DB after it was marked as read and then deleted
	 * @param notifiction
	 */
	...
	/**used to generate a notification string after being sent a notification type and a parameter
